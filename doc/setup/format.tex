...
\lstdefinestyle{C++}{
   ...
   TEST_F, TEST, TEST_G, it, ASSERT_EQ, ASSERT_NE, ASSERT_TRUE, ASSERT_FALSE, ASSERT_THAT, expect_that, describe, FIXTURE, SETUP, TEARDOWN, SETUP_CLASS, TEARDOWN_CLASS, before, after, before_all, after_all, before_class, after_class, eq, ne, le, le, gt, ge, is, is_not, nil, starts_with, ends_with, be_true, be_false, nil,
