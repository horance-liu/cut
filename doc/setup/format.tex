...
\lstdefinestyle{C++}{
   ...
   before, after, before_class, after_class, before_all, after_all, TEST_F, TEST, TEST_G, it, ASSERT_THAT, ASSERT_NE, ASSERT_TRUE, ASSERT_FALSE, ASSERT_THAT, expect_that, describe, FIXTURE, SETUP, TEARDOWN, SETUP_CLASS, TEARDOWN_CLASS, BEFORE, AFTER, BEFORE_CLASS, AFTER_CLASS, BEFORE_ALL, AFTER_ALL, eq, ne, le, le, gt, ge, is, is_not, nil, starts_with, ends_with, be_true, be_false, nil,
